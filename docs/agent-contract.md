...
- `.specify/agent-guides/story-creation-guide.md`：跨 agent 的小说创建引导协议，解决“只解释 story-spec、不带作者开始”的问题。
...
- 遇到 story-spec、小说创建、剧情设定、章节规划或“怎么开始”时，先读取 `.specify/agent-guides/story-creation-guide.md`，主动引导作者创建第一版 StorySpec。
