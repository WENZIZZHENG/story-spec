...
| P1/P2 | [协作写作与正典合并路线图](collaboration-canon-roadmap.md) | Active | 候选、评论、审批、正典 patch、导入导出、插件/团队模板 | P1-6 协作正典协议底座、HTTP 控制面、PostgreSQL repository、只读审阅面板 API、proposal 评论线程 API 和项目活动流 API 已完成；后续进入评论审批 UI 和真实 apply executor |
