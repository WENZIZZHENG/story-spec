...
3. 下一步为多人平台 P1 实现任务逐项建立 OpenSpec：真实 OpenHands headless 执行、worker dashboard/告警/HA 和独立前端项目。
