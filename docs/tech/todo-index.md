...
| 优先级 | 路线 | 状态 | 覆盖范围 | 下一步 |
| --- | --- | --- | --- | --- |
| P1 | [StorySpec 生态与类型包增强路线图](storyspec-ecosystem-roadmap.md) | Active | 已完成 `extension:add` 和首个 `mystery` 类型 preset；剩余 reviewer 权重、生态诊断文案 | 将 reviewer 权重接入转为 OpenSpec |
