...
| 优先级 | 路线 | 状态 | 覆盖范围 | 下一步 |
| --- | --- | --- | --- | --- |
| P1 | [Agent、CI 与自然语言质量增强路线图](agent-ci-quality-roadmap.md) | Active | 已完成新增 agent 准入清单和 CI check manifest；剩余 Vale / textlint 可选 adapter | 将可选 prose lint adapter 转为 OpenSpec |
