...
| 优先级 | 路线 | 状态 | 覆盖范围 | 下一步 |
| --- | --- | --- | --- | --- |
| P1 | [StorySpec 生态与类型包增强路线图](storyspec-ecosystem-roadmap.md) | Active | 已完成 `extension:add`、首个 `mystery` 类型 preset 和 reviewer 权重；剩余生态诊断文案 | 将生态 kind 展示口径统一转为 OpenSpec |
