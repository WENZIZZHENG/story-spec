...
3. 下一步执行 [full-refactor-workbench.md](full-refactor-workbench.md) 的 Batch C0-C2。先落地 Context Pack、Draft/Revision、Narrative Tests，再推进 Dialogue、Branch、Promise、Research、Style、Compile 与 Feedback。
