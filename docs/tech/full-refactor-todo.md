...
1. 继续 [full-refactor-agent-neutral.md](full-refactor-agent-neutral.md) 的 Batch A2。A0、A1 与脚本能力降级子批次 A2a 已完成，下一步收口 agent 能力文档、README 主叙事与旧 `--ai` 兼容说明。
2. 执行 [full-refactor-worldbuilding.md](full-refactor-worldbuilding.md) 的 Batch B0-B3。先建立 World / Canon 基座，再推进 Entity Graph、Scene Card、Quality / Voice / Reviewer 与 Genre Preset。
3. 执行 [full-refactor-workbench.md](full-refactor-workbench.md) 的 Batch C0-C2。先落地 Context Pack、Draft/Revision、Narrative Tests，再推进 Dialogue、Branch、Promise、Research、Style、Compile 与 Feedback。
...
- 已完成批次要同步勾选专题文件与 Shared 批次映射，并在说明中保留覆盖的旧编号范围。
