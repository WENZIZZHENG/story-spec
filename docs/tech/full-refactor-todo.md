...
2. 下一步执行 [full-refactor-worldbuilding.md](full-refactor-worldbuilding.md) 的 Batch B0-B3。先建立 World / Canon 基座，再推进 Entity Graph、Scene Card、Quality / Voice / Reviewer 与 Genre Preset。
