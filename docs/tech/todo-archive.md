...
| [creative-control-roadmap.md](creative-control-roadmap.md) | Completed | Batch D10：README、创作控制权指南、commands/workflow/index 文档与旧项目迁移说明 | [creative-control-roadmap.md](creative-control-roadmap.md#batch-d10文档教程与用户引导) / [2026-05-03-creative-control-docs.md](../../changes/2026-05-03-creative-control-docs.md) | 新增强路线时回到 todo-index 登记 |
