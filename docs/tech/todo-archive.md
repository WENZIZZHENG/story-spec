...
| --- | --- | --- | --- | --- | --- |
| [platform-foundation-roadmap.md](platform-foundation-roadmap.md) | Completed | P0-1 依赖安装与 CI 可复现性、P0-2 命令产物与 compiled runtime 分离、P0-3 README 高频命令去重与事实边界巡检 | [2026-05-11-ci-bun-lockfile.md](../../changes/2026-05-11-ci-bun-lockfile.md)、[2026-05-11-preserve-runtime-command-build.md](../../changes/2026-05-11-preserve-runtime-command-build.md)、[2026-05-11-readme-command-fact-boundaries.md](../../changes/2026-05-11-readme-command-fact-boundaries.md)、`openspec/changes/align-ci-bun-lockfile`、`openspec/changes/preserve-runtime-when-building-commands`、`openspec/changes/dedupe-readme-command-fact-boundaries` | OpenSpec strict validate、相关 unit、`npm run build`、`npm run build:commands`、`node dist/cli.js --help`、`npm run check:command-manifest`、`npm run check:changes`、`git diff --check` | 完整 App 产品体验设计和多人平台 API contract 回到 [todo-index.md](todo-index.md) 继续推进 |
...
| 原文件 | 状态 | 完成范围 | 详细证据 | 验证口径 | 后续入口 |
| --- | --- | --- | --- | --- | --- |
| [app-multiuser-roadmap.md](archive/completed-roadmaps/app-multiuser-roadmap.md) | Completed 第一阶段 | `storyspec app` 本机服务地基、零依赖工作台 shell、项目打开/创建、创作入口、核心缺口、候选大纲、只读任务板、章节草稿入口、Scene Card 初始化和章节级写后自检 | [2026-05-06-local-app-workbench-foundation.md](../../changes/2026-05-06-local-app-workbench-foundation.md)、[2026-05-06-local-app-shell-ui.md](../../changes/2026-05-06-local-app-shell-ui.md)、[2026-05-06-local-app-intake-core.md](../../changes/2026-05-06-local-app-intake-core.md)、[2026-05-06-local-app-outline-task-views.md](../../changes/2026-05-06-local-app-outline-task-views.md)、[2026-05-06-local-app-chapter-entry.md](../../changes/2026-05-06-local-app-chapter-entry.md)、`openspec/changes/add-local-app-chapter-entry` | OpenSpec strict validate、相关 App unit、`npm run build`、`npm run check:changes`、`git diff --check` | 多用户账号与项目隔离、统一 preview/apply lane 或前端框架化需回到 todo-index 激活并新建 OpenSpec |

## 本机启动体验优化

| 原文件 | 状态 | 完成范围 | 详细证据 | 验证口径 | 后续入口 |
| --- | --- | --- | --- | --- | --- |
| [app-startup-experience-roadmap.md](app-startup-experience-roadmap.md) | Completed | 启动入口分层指引、`storyspec app` 端口占用回退与结果提示、`storyspec doctor` 环境自检 | [2026-05-08-app-startup-experience.md](../../changes/2026-05-08-app-startup-experience.md)、`openspec/changes/improve-app-startup-experience` | `npx openspec validate improve-app-startup-experience --strict --json --no-interactive`、相关 unit/smoke、`npm run build`、`npm run check:changes`、`git diff --check` | 多用户账号与项目隔离按 [多用户 App 路线收口](#多用户-app-路线收口) 继续收口 |

## 多用户 App 路线收口

| 原文件 | 状态 | 完成范围 | 详细证据 | 验证口径 | 后续入口 |
| --- | --- | --- | --- | --- | --- |
| [app-multiuser-roadmap.md](archive/completed-roadmaps/app-multiuser-roadmap.md) | Completed | `storyspec server` 多用户控制平面基础、项目/成员/job 列表、job 控制、runtime adapter foundation、项目生命周期计划、安全回归、最小自托管配置 | [2026-05-08-multiuser-server-entry.md](../../changes/2026-05-08-multiuser-server-entry.md)、[2026-05-08-multiuser-database-foundation.md](../../changes/2026-05-08-multiuser-database-foundation.md)、[2026-05-08-multiuser-http-auth-guards.md](../../changes/2026-05-08-multiuser-http-auth-guards.md)、[2026-05-08-multiuser-project-api-guard.md](../../changes/2026-05-08-multiuser-project-api-guard.md)、[2026-05-08-multiuser-job-api-control-plane.md](../../changes/2026-05-08-multiuser-job-api-control-plane.md)、[2026-05-08-multiuser-job-audit-quota-guards.md](../../changes/2026-05-08-multiuser-job-audit-quota-guards.md)、[2026-05-08-multiuser-runtime-app-observability.md](../../changes/2026-05-08-multiuser-runtime-app-observability.md)、[2026-05-08-multiuser-data-deploy-security.md](../../changes/2026-05-08-multiuser-data-deploy-security.md) | OpenSpec strict validate、相关 unit/security、`npm run build`、`npm run check:changes`、`git diff --check` | 当前暂无活跃多用户路线；如需继续增强，先新建单独 OpenSpec change |
