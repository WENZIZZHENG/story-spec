...
Planned。本文记录 2026-05-04 在“法术编译纪元”第一章 dogfood 后发现的 StorySpec 流程优化点，目标是减少每章写作后的手工收尾、误报噪音和路径返工。
...
3. P1-1：降低 compile 在早期章节的 warning 噪音。
4. P1-2 与 P1-3：治理叙事债务和历史澄清 info。
5. P2-1 与 P2-2：继续降低生成物和任务状态维护成本。
