...
Active。本文记录 2026-05-04 在“法术编译纪元”第一章 dogfood 后发现的 StorySpec 流程优化点，目标是减少每章写作后的手工收尾、误报噪音和路径返工。P0 基线、P1-1/P1-2/P1-3 与 P2-1 已完成，当前下一步是 P2-2：任务看板刷新与 tasks 状态更新保持幂等。
