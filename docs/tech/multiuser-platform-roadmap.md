...
- 缺口：独立前端项目首片 shell、登录/权限只读 UI contract、静态构建链、本地预览服务、错误边界组件和 HTTP 级 E2E 已建立；仍缺状态管理、真实账号/团队 mutation UI、浏览器级端到端测试和可维护组件边界。
- 建议方案：
