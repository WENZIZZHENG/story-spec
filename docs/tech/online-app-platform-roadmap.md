...
| 优先级 | 子路线 | 状态 | 覆盖范围 | 下一步 |
| --- | --- | --- | --- | --- |
| P0 | [平台地基与发布边界路线图](platform-foundation-roadmap.md) | Active | 依赖/CI 可复现性已完成；待处理命令产物与 compiled runtime 分离、README 事实边界 | 下一步处理 P0-2 命令产物与 compiled runtime 分离 |
...
1. [platform-foundation-roadmap.md](platform-foundation-roadmap.md) 的 P0-2/P0-3。
