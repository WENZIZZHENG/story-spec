...
- `templates/agent/agent-contract.md` 作为项目级 agent 合约模板，由 `initProject` 同步为 `.specify/agent-contract.md` 和根目录 `AGENTS.md`，并渲染中文 `{{AGENTS_PROFILE_SECTION}}`；`templates/AGENTS.codex.md` 保留为 Codex 专用兼容模板，同样使用中文。
