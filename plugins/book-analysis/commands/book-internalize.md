...
**本命令的目的**：将 `book-analysis` 插件生成的分析报告，自动转化为 StorySpec 项目的配置文件，让对标作品的风格成为你创作的"底层参考"。
...
- **低于**：`memory/storyspec-constitution.md`（创作宪法）
- **低于**：用户即时指令
...
**风格参考的优先级**：
1. 用户即时指令（最高）
2. `memory/storyspec-constitution.md`（创作宪法）
